# Problem Set 2, hangman.py part 3
# Name: Era
# Collaborators:
# Time spent:
...
def hangman(secret_word):
    ...
    * After each guess, you should display to the user the 
    ...
    while True:
      ...
      print('Avialable letters: {}'.format(get_available_letters(letters_guessed)))
      ...
      if letter_guessed.isalpha():
         if letter_guessed not in letters_guessed:
             ...
             if Warnings > 0:
                 Warnings -= 1
                 print("Oops! You've already guessed that letter. You now have {} warnings.".format(Warnings))
             else:
                 guesses -= 1
         ...
         if is_word_guessed(secret_word, letters_guessed):
             ...
             print('Your total score for this game is {}'.format(len(unique_letters)*guesses))
             break
